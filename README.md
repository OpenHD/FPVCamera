...
Other than providing a live video stream via USB, an ideal FPV Camera shall also provides an interface to change the following parameters via USB (minimum):
- framerate
- resolution
- bitrate
